 ...
 */
export function NasilHesaplandi({ baslik = "Nasıl hesaplandı?", ozet, children, className = "" }: NasilHesaplandiProps) {
  return (
    <details className={`group rounded-xl border p-3 ${className}`}>
